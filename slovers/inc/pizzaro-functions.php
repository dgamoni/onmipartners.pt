	...
	function pizzaro_newsletter_form() {
		...
		<form>
			<div class="newsletter-form">
				<input type="text" placeholder="<?php echo esc_attr( __( 'Insira aqui seu email para receber a nossa newsletter', 'pizzaro' ) ); ?>">
				<button class="button" type="button"><?php echo esc_html__( 'Subscrever', 'pizzaro' ); ?></button>
			</div>
		</form>
		<?php
